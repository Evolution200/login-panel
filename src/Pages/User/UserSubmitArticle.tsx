    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                ...
                setPdfBase64(base64String.split(',')[1]);
            };
    ...
    return (
        <UserLayout>
            <div className="space-y-8">
                ...
                <form className="space-y-16 bg-white shadow-md rounded-lg p-6" onSubmit={handleSubmit}>
                    <div>
                        <label htmlFor="taskName"
                               className="inline-block w-[155px] text-center font-semibold round-full text-indigo-700 mb-2 border-2 border-indigo-200 bg-indigo-200 rounded-xl px-2 py-1">
                            Title
                        </label>
                        <input
                            id="taskName"
                    ...
                    <div>
                        ...
                        <label htmlFor="keywords" className="px-3 inline-block text-sm font-medium text-gray-700">
                            (Comma Seperated)
                        </label>
                        <input
                            id="keywords"
                    ...
                    <div>
                        ...
                        <div className="mt-1 flex items-center">
                            ...
                            <label
                                htmlFor="pdf"
                                className="cursor-pointer bg-blue-100 py-2 px-12 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transform hover:scale-105"
                            >
                                Choose File
                            </label>
                            <span className="inline-block mr-1 ml-6">
                            ...
                            <span className="ml-1 text-sm text-gray-500">{fileName}</span>
                        </div>
                    </div>
